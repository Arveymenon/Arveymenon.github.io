    ...
    <main class="main main--home" style="opacity:0">
        ...
        <div class="header">
            ...
            <div class="header__right">
                ...
                <div class="header__phone"><a href="tel:+23155908368">+91 99208 07002</a></div>
            </div>
        </div>
        <div class="scroll">
            <div class="home-page"> ̰ ̰ ̰ ̰
                        ...
                        <div class="content">
                            <div class="content__left">
                                <div class="content__title">
                                    ...
                                    <div class="h1">APP &</div>
                                    <div class="h1">WEBAPP</div>
                                </div>
                                <div class="content__description">
                                    <div class="small">Hello, my name is Arul and I run an IT firm. We develop all sorts of softwares, right from Webapps to system apps to Mobile Application. Everything</div>
                                </div>
                                <div class="content__btn-block">
                                    <div class="content__btn-label small">(hire me :)</div><a
                                        class="content__btn-btn btn btn--arrow js-scroll-link" href="#hireme"
                                        data-link="6">
                                        <svg>
                                ...
                                <div class="home__numbers">
                                    ...
                                    <div class="home__number">
                                        <div class="home__number-digital" data-number="25">25</div>
                                        <div class="home__number-text small">Technologies <br>worked with</div>
                                    </div>
                                    <div class="home__number">
                    ...
                    <section class="projects">
                        ...
                        <div class="content">
                            <div class="content__left">
                                ...
                                <div class="content__btn-block">
                                    <div class="content__btn-label small">View all works</div><a
                                        class="content__btn-btn btn btn--arrow" href="https://www.behance.net/"
                            ...
                            <div class="content__right">
                                <div class="projects__blocks">
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-1.jpg" alt=""></a></div>
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-2.jpg" alt=""></a></div>
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-3.jpg" alt=""></a></div>
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-4.jpg" alt=""></a></div>
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-5.jpg" alt=""></a></div>
                                    <div class="projects__block active"><a href="#" target="_blank" rel="nofollow"><img
                                                src="img/project-6.jpg" alt=""></a></div>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="awards">
                        ...
                        <div class="content">
                            <div class="content__left">
                                ...
                                <div class="content__description">
                                    <div class="small">Hello, my name is Pavel Suslov and i am UX/UI designer and
                                        front-end developer, im working via developer 9 years and i know all about
                                        design</div>
                                </div>
                                <div class="content__btn-block">
                                    <div class="content__btn-label small">View behance</div><a
                                        class="content__btn-btn btn btn--arrow" href="#">
                                        <svg>
                                            <use xlink:href="./svg/sprite.svg#arrow"></use>
                                        </svg></a>
                                </div>
                            ...
                            <div class="content__right">
                                ...
                                <div class="content__awards awards__list">
                                    ...
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">Has been part of the Envato Community for
                                            over 8 years</div>
                                    </div>
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">Sells items exclusively on Envato Market
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="scrollable">
                    <section class="testimonials">
                        ...
                        <div class="content"
                            style="background-image: url(images/testmonials-bg.png); background-size: auto 100%; background-repeat: no-repeat; background-position: center center;">
                            <div class="content__left">
                                <div class="content__title">
                                ...
                                <div class="content__slider slides testimonials__slider">
                                    <div class="slides__container">
                                        <div class="slides__inner">
                                            <div class="slide">
                                                <div class="content__slider-text small">“ If you are seeking an Interior
                                                    designer that will understand exactly your needs, and someone who
                                                    will utilise their creative and technical skills in parity with your
                                                    taste, then Suzanne at The Bauhaus Studio is perfect.</div>
                                                <div class="content__slider-name">david & elisa</div>
                                                <div class="content__slider-staff small">Apartment view lake at Brooklyn
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="content__slider-text small">“ If you are seeking an Interior
                    ...
                    <section class="experience">
                        ...
                        <div class="content">
                            ...
                            <div class="content__left">
                                ...
                                <div class="content__description">
                                    <div class="small">I have been developing sites for 8 years and I know for sure the
                                        main trends and directions of modern design, you will get a decent result</div>
                                </div>
                                <div class="content__btn-block"><a class="content__btn-btn btn" href="#">resume</a>
                                </div>
                            </div>
                            <div class="content__right">
                                <div class="content__awards experience__list">
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">Assertively exploit wireless initiatives
                                            rather than synergistic core competencies.</div>
                                    </div>
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">im working via developer 9 years and i
                                            know all about design</div>
                                    </div>
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">Credibly streamline mission-critical
                                            value with multifunctional functionalities. Leading team designers.</div>
                                    </div>
                                    <div class="content__award">
                                        ...
                                        <div class="content__award-text small">Proven ability to lead and manage a wide
                                            variety of design and development projects in team and independent
                                            situations.</div>
                                    </div>
                                    <div class="content__award">
                    ...
                    <section class="news">
                        ...
                        <div class="content">
                            <div class="content__left">
                                ...
                                <div class="content__btn-block">
                                    <div class="content__btn-label small">View all works</div><a
                                        class="content__btn-btn btn btn--arrow" href="blog.html" target="_blank">
                                        <svg>
                                            <use xlink:href="./svg/sprite.svg#arrow"></use>
                                        </svg></a>
                                </div>
                            ...
                            <div class="content__right">
                                <div class="news__blocks">
                                    <div class="news__block active">
                                        ...
                                        <div class="news__block-image"><a href="blog.html" target="_blank"><img
                                                    src="img/news-1.jpg" alt=""></a></div>
                                    </div>
                                    <div class="news__block active">
                                        <div class="news__block-info">
                                            <div class="news__block-date small">3th January, 2020</div>
                            ...
                            <div class="content__left">
                                ...
                                <ul class="content__menu contacts__menu">
                                    <li class="active"><a class="noicon" href="javascript:;"
                                            onclick="window.open('mailto:robert@info.com')">mail: <span
                                                class="__cf_email__"
                                                data-cfemail="dcaeb3beb9aea89cb5b2bab3f2bfb3b1">[email&#160;protected]</span></a>
                                    </li>
                                    <li class="active"><a class="noicon" href="javascript:;"
                                            onclick="window.open('skype:robert')">skype: robert</a></li>
                                    <li class="active"><a href="https://behance.net/Paulggooo"
                                            target="_blank">www.behance.net/Paulggooo</a></li>
                                    <li class="active"><a class="noicon" href="https://t.me/robert_inc"
                                            target="_blank">telegram: robert_inc</a></li>
                                </ul>
                                <div class="contacts__copyright small">© Pattison 2021. All Rights Resevered</div>
                            </div>
                            <div class="content__right">
                                <div class="content__subtitle">Let's grab a coffee and jump on <span>conversation</span>
                                    chat with me.</div>
                                <form class="content__contacts contacts__form js-contact-form" method="post">
                                    <div class="content__brief">
                                        ...
                                        <div class="content__brief-text small">I recommend filling out a brief to assess
                                            the cost of the project. <label for="brief">Brief</label></div>
                                    </div>
